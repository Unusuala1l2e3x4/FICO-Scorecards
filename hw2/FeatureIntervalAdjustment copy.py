...
def feature_stat(x, y, decoded_x=None, delimiter='~'):
...
def feature_stat_str(x, y, decoded_x=None, delimiter='~', n_lines=40, width=20):
    ...
    """
    res = feature_stat(x,y,decoded_x,delimiter) # Compute the feature distrition table
...
def plot_event_dist(x, y, decoded_x=None, delimiter='~',
    ...
    map_xticks = data[['x','x_b','decoded_x']].drop_duplicates().sort_values('x_b')
    ...
    if xticks is None:
        plot_x_labels = map_xticks['decoded_x']
    else:
    ...
    # feature distribution table_
    tem_stat = feature_stat(x,y,decoded_x=decoded_x) 
    tem_stat_str = feature_stat_str(x,y,decoded_x=decoded_x)
